...
import { LegalMonetaryTotal, ListAgencyNameEnum, Party } from './types/pef-invoice.types';
...
describe('generatePEF', (): void => {
  ...
  it('should call pdfMake.createPdf and return its result', () => {
    ...
    const invoice: Partial<PEFSpecInvoice> = {
      ...invoiceHeader,
      ...legalMonetaryTotal,
    ...
    const result: TCreatedPdf = generateSpecPEF(invoice as PEFSpecInvoice, additionalData);
